...
///								race_add_table().
function race_get_table(table_name) {
	return variable_struct_get(__RACE_GLOBAL, table_name);
}
...
///								NOTE: This method may crash if table does not exist or is not loaded!
function race_table_get_item(table, item_name) {
	return variable_struct_get(variable_struct_get(table, __RACE_FIELD_ITEMS), item_name);
}
...
function race_table_get_loot_count(table) {
	return variable_struct_get(table, __RACE_FIELD_LOOT_COUNT);
}
...
///								If the table is not found, undefined is returned.
function race_table_get_items(table) {
	return variable_struct_get(table, __RACE_FIELD_ITEMS);
}
...
///								NOTE: This method may crash if table does not exist or is not loaded!
function race_table_get_item_names(table) {
	return variable_struct_get_names(variable_struct_get(table, __RACE_FIELD_ITEMS));
}
...
///								If the table is not found, undefined is returned.
function race_table_get_name(table) {
	return variable_struct_get(table, __RACE_FIELD_NAME);
}
...
function race_table_set_loot_count(table, new_loot_count) {
	variable_struct_set(table, __RACE_FIELD_LOOT_COUNT, new_loot_count);
}
...
function race_table_set_name(table, new_name) {
	variable_struct_set(table, __RACE_FIELD_NAME, new_name);
}
